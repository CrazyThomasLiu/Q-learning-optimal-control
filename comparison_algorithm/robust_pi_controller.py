...
F_A=np.array([[0.0604, -0.0204], [-0.0204, 0.0]])*2.72
F_B=np.array([[0.062], [-0.0464]])


'3. The PI control law'
#K_p=np.array([[0.32300948]])
#K_i=([[0.037681506696208775]])
#K_p=np.array([[0.39686553]])
#K_i=([[0.07112118166197105]])
#alpha=0.8
#K_p=np.array([[0.06013575]])
#K_i=([[1.8745445827559262e-07]])

#alpha=0.6
#K_p=np.array([[0.2221142]])
#K_i=([[4.154991642492975e-06]])
#alpha=0.4
#K_p=np.array([[0.47933047]])
#K_i=([[0.24318807852931348]])
#alpha=0.6 r=0.25
#K_p=np.array([[0.23997887]])
#K_i=([[0.03154122034823366]])
#alpha=0.2 r=0.75
#K_p=np.array([[0.63793504]])
#K_i=([[0.1096406274562183]])

#alpha=0.2 r=0.75 without time model
K_p=np.array([[0.59805595]])
K_i=([[0.09902890747404931]])
