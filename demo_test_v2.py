...
ax0.legend(['Reference Trajectory','Q_learning','Model-based Optimal Control'])
#plt.ylim(ymin=0)
...
ax1.plot(time, mb_state_u, label='smoothed')
xlable = 'Time:$t$'
ylable = 'Control Signal:$u$'
plt.xlabel(xlable,font)
plt.ylabel(ylable,font)
ax1.grid()
ax1.legend(['Q_learning','Model-based Optimal Control'])
if save_figure==True:
